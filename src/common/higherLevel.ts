...
export const getCurrentValueForEachLevelUpgrade = (currentLevel: number, spellLevel: number, rules: EachLevelUpgrades) => {
...
export const getCurrentValue = (currentLevel: number, spellLevel: number, rules: CertainLevelUpgrades<number> | EachLevelUpgrades) => {
