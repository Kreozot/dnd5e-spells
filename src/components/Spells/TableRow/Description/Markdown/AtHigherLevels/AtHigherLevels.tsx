...
// Translates <AtHigherLevels initial="1 beast" upgrades="5:2 beasts;7:3 beasts;9:4 beasts"/>
// into value relevant for spell slot level
type Props = {
  initial: string;
  eachLevelInc?: string;
  postfix?: string;
...
const AtHigherLevels: FC<Props> = (props) => {
  const {
    initial, eachLevelInc, postfix, spellLevel, spellTitle, upgrades, hint,
  } = props;
